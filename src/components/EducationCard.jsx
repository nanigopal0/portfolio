export default function EducationCard({
  ...
  return (
    <div className="w-full md:w-4/5 lg:w-3/5 flex items-center gap-8">
      <p className="font-bold font-mono text-lg text-green-400">{year}</p>
    ...
    <div className="w-full border border-white/20 backdrop-blur-lg bg-white/10 rounded-2xl p-6">
      ...
      <div className="md:flex justify-between items-center">
        <div>
          <p className="school-name text-lg text-teal-400 font-medium mb-1">
            {schoolName}
          </p>
          <p className="text-sm text-gray-300 mb-3">{address}</p>
        </div>
